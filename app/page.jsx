...
export default function Home() {
  return (
    <main className="mt-40 text-white bg-black min-h-screen">
      <HeroSection />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {testimonialsData.map((testimonial, index) => (
              <Card 
                key={index} 
                className="p-6 bg-zinc-900 border-zinc-800 hover:border-zinc-700 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/10 transition-all duration-300"
              >
